...
- [`0-hello_world`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/0-hello_world)
...
- [`1-confused_smiley`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/1-confused_smiley)
...
- [`2-hellofile`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/2-hellofile)
...
- [`3-twofiles`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/3-twofiles)
...
- [`4-lastlines`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/4-lastlines)
...
- [`5-firstlines`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/5-firstlines)
...
- [`6-third_line`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/6-third_line)
...
(
as
iacta alea est) to Julius Caesar on January
10
,
49
BC
as
he led his army across the Rubicon river
in
Northern Italy. With
this
step,
he entered Italy at the head of his army
in
defiance of the Senate and began
...
- [`7-file`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/7-file)
...
- [`8-cwd_state`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/8-cwd_state)
...
. If the file
ls_cwd_content
already exists, it should be overwritten. If the file
ls_cwd_content
...
- [`9-duplicate_last_line`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/9-duplicate_last_line)
...
- [`10-no_more_js`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/10-no_more_js)
...
- [`11-directories`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/11-directories)
...
- [`12-newest_files`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/12-newest_files)
...
- [`13-unique`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/13-unique)
...
- [`14-findthatword`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/14-findthatword)
...
- [`15-countthatword`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/15-countthatword)
...
- [`16-whatsnext`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/16-whatsnext)
...
- [`17-hidethisword`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/17-hidethisword)
...
- [`18-letteronly`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/18-letteronly)
...
- [`19-AZ`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/19-AZ)
...
$ echo '
Replace
all characters `A` and `c` from input to `Z` and `e`.'
|
./
19
-
AZ
Replaee
all eharaeters `Z` and `e` from input to `Z` and `e`.
julien
@ubuntu
:
/tmp/
...
- [`20-hiago`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/20-hiago)
...
- [`21-reverse`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/21-reverse)
...
- [`22-users_and_homes`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/22-users_and_homes)
...
<details>
<summary>23. Empty casks make the most noise #advanced</summary>

**Files:**

- [`23-empty_casks`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/23-empty_casks)
...
<details>
<summary>24. A gif is worth ten thousand words #advanced</summary>

**Files:**

- [`24-gifs`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/24-gifs)
...
<details>
<summary>25. Acrostic #advanced</summary>

**Files:**

- [`25-acrostic`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/25-acrostic)
...
<details>
<summary>26. The biggest fan #advanced</summary>

**Files:**

- [`26-the_biggest_fan`](https://github.com/Antgst/holbertonschool-shell/blob/main/io_redirections_and_filters/26-the_biggest_fan)
...
host
When
possible, the hostname making the request. Uses the IP address if the hostname was unavailable.
...
171.144
Connecting
to s3.amazonaws.com (s3.amazonaws.com)|
52.217.171.144
|
:
443
...
./
26
-the_biggest_fan < nasa_19950801.tsv
edams.ksc.nasa.gov
130.110
.
74.81
